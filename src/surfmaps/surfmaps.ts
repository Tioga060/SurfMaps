...
import { store, RootState } from './modules/SurfmapsModule/store';
...
import {
  ...
  updateOffline,
  updateDrawerState
} from './modules/SurfmapsModule/actions';
...
@customElement('surf-maps')
export class SurfMaps extends connect(store)(LitElement) {
